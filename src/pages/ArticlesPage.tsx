...
export default function ArticlesPage() {
  ...
  return (
    <>
      ...
      <PageHeader crumbs={[{ name: 'Home', path: '/' }, { name: 'Health Insights', path: '/articles' }]} title="Health Articles" intro="Practical, general health information to help you stay informed." image={pageImages.articles} />
