...
export const gallery: GalleryItem[] = [
  ...
  img('g15', 'Campus frontage', 'Campus', 'campus-exterior-front.webp', 1536, 862),
  img('g16', 'Emergency & casualty bay', 'Facilities', 'emergency-bay.webp', 1536, 862),
  img('g18', 'Cath lab & interventional suite', 'Facilities', 'cath-lab.webp', 1536, 862),
  img('g19', 'CT scanner', 'Facilities', 'ct-scanner.webp', 1536, 862),
  img('g20', 'Neonatal intensive care unit', 'Facilities', 'neonatal-icu.webp', 1536, 862),
  img('g21', 'Pathology laboratory', 'Facilities', 'pathology-lab.webp', 1536, 862),
  img('g22', 'General ward', 'Facilities', 'general-ward.webp', 1536, 862),
  img('g23', 'Nursing station', 'Care Team', 'nursing-station.webp', 1536, 862),
  img('g24', 'Echocardiography', 'Facilities', 'echocardiography.webp', 1536, 862),
  img('g25', 'Surgery in theatre', 'Facilities', 'surgery-in-theatre.webp', 1536, 862),
];
